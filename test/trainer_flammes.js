/*
  ...
  - On affiche le compteur de flammes dans la navbar et ailleurs via l'attribut [count_flammes].
  ...
  - Met à jour partout les éléments [count_flammes].
...
(function () {
  ...
  function updateDomFlames(flames) {
    const nodes = document.querySelectorAll('[count_flammes]');
